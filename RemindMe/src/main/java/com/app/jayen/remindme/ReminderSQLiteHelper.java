...
public class ReminderSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_REMINDER + "(" + COLUMN_ID +
            " integer primary key autoincrement, " + COLUMN_TITLE + " text not null, " + COLUMN_TITLE + "text not null, "
